        ...
        <div className='container p-3'>
          <nav
            className={`flex items-center py-3 px-4 justify-between ${
              sticky
                ? ' rounded-full shadow-lg bg-white/20 dark:bg-white/10 backdrop-blur-md border border-white/30 dark:border-white/10'
                : null
            } `}>
            ...
            <div className='flex items-center gap-1 xl:gap-4'>
              ...
              {user?.user || session?.user ? (
                ...
                <div className='flex items-center gap-2'>
                  <Link
                    href={'/contact'}
                    className='hidden lg:block text-white px-3 xl:px-4 py-2 bg-dark_black/90 dark:bg-white/15 rounded-full border border-white/15 hover:opacity-90 hover:-translate-y-0.5 transition-all duration-200'>
                    Get in touch
                  </Link>
                </div>
              )}
              ...
              <div className='flex flex-col items-center gap-3 px-2 mt-2'>
                {user || session?.user ? (
                  ...
                  <>
                    <Link
                      href={'/contact'}
                      className='w-full text-white dark:text-dark_black px-4 py-2 bg-dark_black dark:bg-white rounded-md border border-dark_black/10 dark:border-white/20 hover:opacity-90 text-center'>
                      Get in touch
                    </Link>
                  </>
                )}
