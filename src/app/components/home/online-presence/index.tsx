                ...
                >
                  <div className='relative overflow-hidden rounded-2xl'>
                    ...
                    <Link
                      ...
                      target='_blank'
                      className='absolute inset-0 flex items-start justify-end p-5 bg-gradient-to-tr from-black/60 via-black/30 to-transparent backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out pointer-events-none group-hover:pointer-events-auto'
                    >
                      <span className='flex rounded-full bg-white/15 p-2.5 backdrop-blur-md shadow-lg'>
                        <Icon
